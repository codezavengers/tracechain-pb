...
import { normalizeNative, normalizeToken, baseUnitsToDecimal } from "@/lib/blockchain/normalize"
import {
  MAX_ROWS_PER_PAGE,
  DEFAULT_MAX_PAGES,
...
export class TronProvider extends AbstractProvider {
  ...
  private trc20ToTokenTransfer(t: TronTrc20Tx, address: string): TokenTransfer | null {
